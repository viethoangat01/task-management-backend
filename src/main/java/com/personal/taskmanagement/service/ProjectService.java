...
public class ProjectService {
  ...
  public ProjectDto updateProject(ProjectDto projectDto) {
    ...
    // Validate startDate and endDate
    LocalDate startDate =
        projectDto.getStartDate() == null ? project.getStartDate() : projectDto.getStartDate();
    LocalDate endDate =
        projectDto.getEndDate() == null ? project.getEndDate() : projectDto.getEndDate();
    ...
    // Validate owner and update new projectMember list
    User owner = projectDto.getOwner() == null ? project.getOwner()
        : userRepo.findById(projectDto.getOwner().getId())
            .orElseThrow(() -> new InvalidValueException("owner",
                "owner with id " + projectDto.getOwner().getId() + " is not exist"));
    ...
    if (projectDto.getMembers() != null) {
      List<Long> memberIds = projectDto.getMembers().stream()
          .map(MemberDto::getId)
          .toList();
      if (memberIds.contains(owner.getId())) {
    ...
    project.setDescription(projectDto.getDescription() == null ? project.getDescription()
